...
Test-Check "  VSCode extension exists" { Test-Path (Join-Path $root "extension\extension.js") }
Test-Check "  Release workflow exists" { Test-Path (Join-Path $root ".github\workflows\release.yml") }

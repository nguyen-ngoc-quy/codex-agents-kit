...
| **Profile System** | Switch configs with one command: `free`, `premium`, `local` |
...
| **Prompt Library** | Optimized prompts for ASP.NET, Flutter, Unity, SQL, Docker, Testing |
...
- Installs wrapper adds `bin/` to your shell PATH

### 3. Available Commands

| Command | Description |
|---------|-------------|
| `codex profile <name>` | Switch profile (`free`, `premium`, `local`) |
...
- [Profiles & Models](docs/Profiles.md)
- [MCP Configuration](docs/MCP.md)
- [AI Agents & Prompts](docs/Agents.md)
